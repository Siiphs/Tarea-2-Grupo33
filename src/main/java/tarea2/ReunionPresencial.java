 ...
 * 
 * la clase ReunionPresencial hereda aspectos de Reunion, ya que esta es una forma mas especifica de esta ultima.
 * @see Reunion
 * 
 */
public class ReunionPresencial extends Reunion{
    /**
     * @param sala es la oficina a la que los trabajadores tendran que ir para asistir la reunion.
     */
    private String sala;
     ...
     * @param esPresencial revisa si la reunion es presencial, o en caso contrario, que sea virtual.
     */
