...
/**
 * La asistencia toma nota de que empleado llega a la reunion y si este llega tarde en sus listas correspondientes.
 * 
 * @author Dario Sepulveda
 * @since 11 de mayo de 2024
 * 
 * @param listaAsistencia es un ArrayList de cada empleado que llego a la reunion, ya sea a la hora o con un retraso.
